...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setErrMessage(checkValidate(email.current.value, password.current.value));
  };
    ...
    <div className="">
      ...
      >
        ...
        <input
          ...
          ref={password}
        />
        <button className="w-full bg-red-700 my-8 p-2 text-white rounded-lg hover:bg-red-800">
          Submit
        </button>
        {errMessage && (
